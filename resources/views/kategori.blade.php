...
@section('content')
    ...
    <div class="site-section">
        <div class="container">
            <div class="row mb-12">
                <div class="col-md-12 mb-0"><a href="{{route('anasayfa')}}">Anasayfa</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">{{$kategori->kategori_adi}}</strong></div>
                                ...
                                <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                                    <div class="block-4 text-center border">
                                        <figure class="block-4-image">
                                            <a href="{{route('urun', $urun->slug)}}"><img src="{{ $urun->resim_url }}" alt="Image placeholder" class="img-fluid"></a>
                                        </figure>
